...
void pdk_draw_border(int cornerSize) {
    ...
    /* Top-right */
    pd->graphics->fillTriangle(LCD_COLUMNS - 11, 10, LCD_COLUMNS - 11 - cs, 10, LCD_COLUMNS - 11,
                               10 + cs, kColorBlack);
    /* Bottom-left */
    pd->graphics->fillTriangle(10, LCD_ROWS - 11, 10 + cs, LCD_ROWS - 11, 10, LCD_ROWS - 11 - cs,
                               kColorBlack);
    /* Bottom-right */
    pd->graphics->fillTriangle(LCD_COLUMNS - 11, LCD_ROWS - 11, LCD_COLUMNS - 11 - cs,
                               LCD_ROWS - 11, LCD_COLUMNS - 11, LCD_ROWS - 11 - cs, kColorBlack);
}
